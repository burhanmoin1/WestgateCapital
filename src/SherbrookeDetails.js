...
import Image2 from './images/Portfolio/Sherbrooke/0002-002_11_DSC07995.jpg';
import Image3 from './images/Portfolio/Sherbrooke/0003-003_10_DSC07972.jpg';
import NavBar from './Navbar';
import Footer from './Footer';

const SherbrookeDetails = ({ propertyName }) => {
...
function SherbrookePage() {
  const propertyName = '2290 Sherbrooke'; // Set property name here
  return (
    <React.Fragment>
      <NavBar />
      <SherbrookeDetails propertyName={propertyName} />
      <Footer />
    </React.Fragment>
  );
}
