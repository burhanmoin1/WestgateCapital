...
import Image1 from './images/Portfolio/Marie-Anne/0001-001_1_DSC07735.jpg';
import Image2 from './images/Portfolio/Marie-Anne/0002-002_10_DSC07742.jpg';
import NavBar from './Navbar';
import Footer from './Footer';

const MarieAnneDetails = ({ propertyName }) => {
...
function MarieAnnePage() {
  const propertyName = 'Marie-Anne'; // Set property name here
  return (
    <React.Fragment>
      <NavBar />
      <MarieAnneDetails propertyName={propertyName} />
      <Footer />
    </React.Fragment>
  );
}

export default MarieAnnePage;